  ...
  try {
    ...
    modal.innerHTML = `
      <div class="modal-content">
        ...
        <img src="${photo.filepath}" alt="${photo.title}" style="width: 100%; max-height: 400px; object-fit: cover; border-radius: 4px; margin-bottom: 1rem;" onerror="this.src='https://via.placeholder.com/600x400?text=No+Image'">
